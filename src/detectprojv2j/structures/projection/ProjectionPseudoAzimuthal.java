...
public class ProjectionPseudoAzimuthal extends Projection
{  
	...
	protected TTransformedLongitudeDirection lon_dir;                      //Measuring londitudes mode
         ...
         public ProjectionPseudoAzimuthal() {
                super();
	...
	public ProjectionPseudoAzimuthal( final double R_,  final double latp_,  final double lonp_, final double lat1_, final TTransformedLongitudeDirection lon_dir_,  final double lon0_,  final double dx_,  final double dy_,  final double c_,  final ICoordFunctionProj pX,  final ICoordFunctionProj pY, final String name_) 
        {
        ...
        @Override
        public String getFamily() { return "Pseudoaz";}
