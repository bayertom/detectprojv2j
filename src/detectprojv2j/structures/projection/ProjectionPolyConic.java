...
public class ProjectionPolyConic extends Projection
{
	...
	protected TTransformedLongitudeDirection lon_dir;                      //Measuring londitudes mode
         ...
         public ProjectionPolyConic() {
                super();
                lat1 = 0;
                cart_pole = new Point3DGeographic (MAX_LAT, 0.0, 0.0);
                lon_dir = NormalDirection;
        }
        
	public ProjectionPolyConic( final double R_,  final double latp_,  final double lonp_,  final double lat1_, final TTransformedLongitudeDirection lon_dir_,  final double lon0_,  final double dx_,  final double dy_,  final double c_,  final ICoordFunctionProj pX,  final ICoordFunctionProj pY, final String name_) 
        {
        ...
        @Override
        public String getFamily() { return "Polyc";}
