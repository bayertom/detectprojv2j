...
//from meridian passing through the cartographic pole
public enum TTransformedLongitudeDirection
{
	NoDirection,            //Projection currently exists only in the normal aspect (ellipsoid -> sphere)
	...
	NormalDirection2,	//Positive direction lefts from the  oriented line connecting the transformed pole and the North Pole, measured at transformed pole (default)
	ReversedDirection2,	//Positive direction rights from the oriented line connecting the transformed pole and the North Pole, measured at transformed pole
