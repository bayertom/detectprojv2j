// Description: Functor, compute the derivative of the inverse coordinate function at currrent iteration i to determine lat_i
...
public class FILatDer {
	...
	public FILatDer(final double X_, final double Y_, final double R_, final double lat1_, final double lat2_, final double lon0_, final double dx_, final double dy_, final ICoordFunctionProj pFILat_) {
                X = X_;
                Y = Y_;
                R = R_;
                lat1 = lat1_;
