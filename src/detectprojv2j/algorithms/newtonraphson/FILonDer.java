...
public class FILonDer {
	...
	public FILonDer(final double X_, final double Y_, final double R_, final double lat1_, final double lat2_, final double lon0_, final double dx_, final double dy_, final ICoordFunctionProj pFILon_) {
                X = X_;
                Y = Y_;
                R = R_;
                lat1 = lat1_;
